...
{ 
  ...
  if (dt_iter >= 1000) {
    ...
    //desired_pos[0] = results[1];
    //desired_pos[1] = results[2];
    //desired_pos[2] = results[0];
    ...
    //refA = encoder_count_A ;
    //refC= encoder_count_C;
    ...
    //String output = "<" + String(errA) + ";" + String(errB) + ";" + String(errC) + ";" + ">";
    ...
    //String output_data_2 = "<" + String(encoder_count_A) + ";"  + String(encoder_count_B) + ";" + String(encoder_count_C) + ";"  + String(desired_pos[2]) + ";"  + String(desired_pos[0]) + ";" + String(desired_pos[1])+ ">";
    String output_data_2 = "<" + String(results[0]) + ";"  + String(results[1]) + ";" + String(results[2]) + ";"  + String(desired_pos[0]) + ";"  + String(desired_pos[1]) + ";" + String(desired_pos[2])+ ">";
