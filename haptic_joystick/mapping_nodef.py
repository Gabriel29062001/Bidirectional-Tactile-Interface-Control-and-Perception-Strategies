...
# We hade force value into this message
# If the force sensor is more than a certain value, he sent the correct value else defaut pos is sent
# example module_0/current_state = [0,0,0] [100,0,0] send to mapping_desired_state_1 = [40,40,40][0,0,0]
...
class MySubscriber(Node):
    ...
    def edit_data(self, msg):
        ...
        if float(numbers[3]) > 200 or float(numbers[4]) > 200 or float(numbers[5]) > 200:
